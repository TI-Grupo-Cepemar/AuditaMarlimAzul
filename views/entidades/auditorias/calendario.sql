...
/*
    ROTA RESPONSÁVEL PELO CRUD DE AUDITORIAS
*/
...
SELECT
'title' AS component,
'Calendário de Auditorias' AS contents,
'mb-4' AS class,
1 AS level,
TRUE AS center;
...
SELECT -- POPUP QUE APARECERÁ QUANDO O REQUISITANTE CLICAR EM EDITAR UMA AUDITORIA
'dynamic' AS component,
...
SELECT -- POPUP QUE APARECERÁ QUANDO O REQUISITANTE CLICAR EM REMOVER UMA AUDITORIA
'dynamic' AS component,
...
'cadastroAuditoria' AS modalCadastro,
TRUE AS botoesEditar;
SELECT 
a.id AS "id",
b.sigla AS "nome",
