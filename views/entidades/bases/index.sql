...
sqlpage.run_sql('..\view_configs\controle_de_acesso.sql', json_object('funcao','13')) AS properties; -- Parâmetro 13) Visualizar bases
...
b.sigla AS "Sigla", 
g.nome AS "Gerente", 
g1.nome "Gerente Regional", 
CONCAT(m.nome, ' / ', e.uf) AS "Localização",
'<div class="dropdown">
